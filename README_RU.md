...
Чистый HTML+TypeScript+JavaScript аудио рекордер для браузера без сервера, который работает полностью в браузере без каких-либо зависимостей от бэкенда. Включает функции транскрибации и перевода речи. Поддерживает английский, украинский и русский языки.
